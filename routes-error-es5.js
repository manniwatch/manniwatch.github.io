(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["routes-error"], {
    ...
    function lk(module, __webpack_exports__, __webpack_require__) {
      ...
      var _not_found_msg_switch_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./not-found-msg-switch.component */
      "Ahdb");
      /* harmony import */
      ...
      function NotFoundComponent_mat_list_item_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      NotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 12,
        vars: 1,
        consts: [[1, "header"], [1, "content"], ["role", "list"], ["role", "listitem", 3, "routerLink", 4, "ngFor", "ngForOf"], ["role", "listitem", 3, "routerLink"], ["matListIcon", ""], ["matLine", ""]],
    ...
    /***/
    function Ahdb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NotFoundMessageSwitchComponent", function () {
        return NotFoundMessageSwitchComponent;
      });
      /* harmony import */
      ...
      var _error_type__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./error-type */
      "bv2a");
      /* harmony import */
      ...
      function NotFoundMessageSwitchComponent_ng_container_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NotFoundMessageSwitchComponent_ng_container_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
      ...
      function NotFoundMessageSwitchComponent_ng_container_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementContainerStart"](0);
      ...
      var NotFoundMessageSwitchComponent = function NotFoundMessageSwitchComponent(route) {
        _classCallCheck(this, NotFoundMessageSwitchComponent);

        this.route = route;
        this.errorTypeObservable = this.route.queryParams.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (value) {
          if (value.type) {
            return value.type;
          }
      ...
      NotFoundMessageSwitchComponent.ɵfac = function NotFoundMessageSwitchComponent_Factory(t) {
        return new (t || NotFoundMessageSwitchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]));
      };

      NotFoundMessageSwitchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        type: NotFoundMessageSwitchComponent,
        selectors: [["app-not-found-msg-switch"]],
        decls: 5,
        vars: 5,
        consts: [[1, "info", 3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"]],
        template: function NotFoundMessageSwitchComponent_Template(rf, ctx) {
          if (rf & 1) {
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgSwitch"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgSwitchCase"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgSwitchDefault"]],
    ...
    /***/
    function CnLE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _error_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./error-type */
      "bv2a");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ErrorType", function () {
        return _error_type__WEBPACK_IMPORTED_MODULE_0__["ErrorType"];
      });
      /* harmony import */
      ...
      __webpack_require__.d(__webpack_exports__, "ErrorModule", function () {
        return _error_module__WEBPACK_IMPORTED_MODULE_1__["ErrorModule"];
      });
      /*!
    ...
    /***/
    function bv2a(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ii8z(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _common_error_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      ErrorRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({
        type: ErrorRoutingModule
      });
      ErrorRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
        factory: function ErrorRoutingModule_Factory(t) {
          return new (t || ErrorRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(errorRoutes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](ErrorRoutingModule, {
    ...
    /***/
    function xguD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _common_error_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./common-error.component */
      "zj5l");
      /* harmony import */
      ...
      var _not_found_msg_switch_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./not-found-msg-switch.component */
      "Ahdb");
      /* harmony import */
      ...
      ErrorModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineNgModule"]({
        type: ErrorModule
      });
      ErrorModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({
        factory: function ErrorModule_Factory(t) {
          return new (t || ErrorModule)();
        },
        providers: [],
        imports: [[_error_routing_module__WEBPACK_IMPORTED_MODULE_5__["ErrorRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_3__["MatListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__["MatIconModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_1__["MatDividerModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](ErrorModule, {
          declarations: [_not_found_component__WEBPACK_IMPORTED_MODULE_7__["NotFoundComponent"], _common_error_component__WEBPACK_IMPORTED_MODULE_4__["CommonErrorComponent"], _not_found_msg_switch_component__WEBPACK_IMPORTED_MODULE_6__["NotFoundMessageSwitchComponent"]],
          imports: [_error_routing_module__WEBPACK_IMPORTED_MODULE_5__["ErrorRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_3__["MatListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__["MatIconModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_1__["MatDividerModule"]]
        });
      })();
      /***/
    ...
    /***/
    function zj5l(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CommonErrorComponent", function () {
      ...
      var CommonErrorComponent = function CommonErrorComponent() {
        _classCallCheck(this, CommonErrorComponent);
      };

      CommonErrorComponent.ɵfac = function CommonErrorComponent_Factory(t) {
        return new (t || CommonErrorComponent)();
      };

      CommonErrorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: CommonErrorComponent,
        selectors: [["app-common-error"]],
        decls: 7,
        vars: 0,
        consts: [[1, "header"]],
        template: function CommonErrorComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
//# sourceMappingURL=routes-error-es5.js.map